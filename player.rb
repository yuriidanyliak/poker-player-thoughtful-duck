...
class Player
  ...
  def bet_request(game_state)
  	...
  	full_raise =  !minimum_raise.zero? ? minimum_raise + (game_state["current_buy_in"]..5000).to_a.shuffle.sample : ((game_state["current_buy_in"] / 2).to_i..game_state["current_buy_in"]).to_a.shuffle.sample
  rescue => err
  	puts err.inspect
